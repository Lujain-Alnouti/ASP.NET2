<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="WebUserControl2.ascx.cs" Inherits="Task1_2_1.WebUserControl2" %>
<style>
    .divv{
        width:150px;
        margin-left:20%;
...
<h4>Your Opinion</h4>
    ...
    <asp:Label ID="Label5" runat="server" Text="Acceptable"></asp:Label>
               <div class="md">
    <asp:Label ID="ap" runat="server" Text="" Width=""  Height="20px" CssClass="sd"></asp:Label></div>
    <br />
